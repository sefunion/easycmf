...
class ApiDocController extends EasyApi
{
    #[Inject]
    ...
    public function login(): ResponseInterface
    {
        ...
        if (empty($app_id) && empty($app_secret)) {
            return $this->error(t('easycmf.api_auth_fail'), EasyCode::API_PARAMS_ERROR);
        }

        if (($code = $this->systemAppService->loginDoc($app_id, $app_secret)) !== EasyCode::API_VERIFY_PASS) {
            return $this->error(t('easycmf.api_auth_fail'), $code);
        }
