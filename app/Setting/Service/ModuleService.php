...
use Easy\Generator\ModuleGenerator;
use Easy\Helper\Str;
...
class ModuleService extends AbstractService implements ModuleServiceInterface
{
    ...
    public function __construct(Easy $easy)
    {
        $this->easy = $easy;
        $this->setModuleCache();
    }
    ...
    {
        try {
            $migrateCommand = ['command' => 'easy:migrate-run', 'name' => $name];
            $seedCommand = ['command' => 'easy:seeder-run', 'name' => $name];
    ...
    public function setModuleCache(?string $moduleName = null, array $data = []): void
    {
        ...
        $this->easy->scanModule();
        $modules = $this->easy->getModuleInfo();
        if (! empty($moduleName)) {
    ...
    public function getModuleCache(?string $moduleName = null): array
    {
        ...
        $this->setModuleCache();
        $this->easy->scanModule();
        return $this->easy->getModuleInfo();
    }
